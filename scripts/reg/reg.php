 ...
 */
 ...
 if(isset($_GET['key']))
 {
	...
	else
	{
		...
		$title = 'Ваш аккаунт на http://gerbesh.ru успешно активирован';
		$message = 'Поздравляю Вас, Ваш аккаунт на http://gerbesh.ru успешно активирован';
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				$title = 'Регистрация на http://gerbesh.ru';
